...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{dahboard_view_new_group.png}
...
\begin{figure}[htbp]
	...
	\label{fig:my_label}
\end{figure}
% TODO: SS of DASHBOARD WITH ONE NEW TASK
\begin{figure}[htbp]
        \centering
...
%TODO: SHOW BOTH SEARCH BAR AND FILTERING
% SS OF SEARCH BAR AND FILTER POINTED (DASHBOARD WITH MULTIPLE TASKS)
\begin{figure}[htbp]
        \centering
	...
	\label{fig:my_label}
\end{figure}
% SS OF ROLLDOWN MENU FOR FILTERING
\begin{figure}[htbp]
        \centering
